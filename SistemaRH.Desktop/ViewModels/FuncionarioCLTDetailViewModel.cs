...
public class FuncionarioCLTDetailViewModel : BaseViewModel
{
    ...
    public void PrepararNovo()
    {
        _id = 0;
        _isEdit = false;
        Nome = ""; CPF = ""; RG = ""; Codigo = ""; Email = ""; EmailEmpresa = ""; Contratante = ""; Telefone = ""; Endereco = ""; Complemento = "";
        Cidade = ""; Estado = ""; Cep = "";
    ...
    private async Task CarregarCamposPersonalizadosAsync(string? valoresJson)
    {
        try
        {
            var definicoes = await _campoPersonalizadoService.GetAplicaveisAsync(TipoFuncionario.CLT);
