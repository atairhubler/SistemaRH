...
public partial class FuncionarioCLTDetailView : Window
{
    ...
    private void Window_Loaded(object sender, RoutedEventArgs e)
    {
        ...
        if (viewModel != null)
        {
            ...
            PopularSalario(viewModel.SalarioBruto);
        }
    }

    private void PopularSalario(decimal valor)
    {
        _formatando = true;
        TxtSalario.Text = valor > 0 ? FormatarSalario(valor.ToString("F2", CultureInfo.InvariantCulture)) : "";
        _formatando = false;
    }
    ...
    private void TxtSalario_TextChanged(object sender, TextChangedEventArgs e)
    {
        ...
        // Separar parte inteira da decimal (vírgula)
    ...
    private static string FormatarSalario(string valorStr)
    {
        // valorStr está em formato invariant (ex: "5000.50")
    ...
    {
        if (DataContext is not FuncionarioCLTDetailViewModel vm) return;
